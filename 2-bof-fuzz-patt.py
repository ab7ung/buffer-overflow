...
#Second step: fuzzing with msf-pattern_create, keep the size same as step one. (msf-pattern_create -l 3000)
#check the eip value for the offset with - msf-pattern_offset (msf-pattern_offset -l 3000 -q (EIP Address))

#verify the offet with mona -  !mona findmsp -distance 3000
